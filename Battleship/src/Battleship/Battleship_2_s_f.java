...
public class Battleship_2_s_f {
    ...
    private void get_set() throws IOException {
        Battleship_2_s_f obj = new Battleship_2_s_f();
        ...
        while (INPUT != null) {
            ...
            Path PATH1 = Paths.get("/home/fazer/Documents/server_location.txt");
            try (OutputStream out = new BufferedOutputStream(Files.newOutputStream(PATH1, WRITE, APPEND))) {
                out.write(liness);
            }
            INPUT = read.readLine();
        }
        Path PATH2 = Paths.get("/home/fazer/Documents/client_location.txt");
